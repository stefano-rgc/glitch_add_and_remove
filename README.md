...
```diff
!The parametrization of the Gaussian in this code follows an earlier version of
!Cunha et al. 2019. Such parametrization, eq. (13) within the paper, was updated
!in its latest version (https://arxiv.org/abs/1909.04966) and the current version
!of this code still needs to be accordingly. As temporary mitigation, such update
